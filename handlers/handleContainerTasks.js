...
module.exports = (req, res, next) => {
	...
	compileInCContainer(req, socketInstance)
		...
		.then(compilationLogs => {
			...
			return linkInCContainer(req, socketInstance);
		})
		.then(linkLogs => {
			/*
			 * linkInCContainer.stdout contains the output of linking
			 * linkInCContainer rejects any error as {error}
			 */
		...
		.catch(error => {
			 ...
			 * ... rejected by compileInCContainer
			 */
